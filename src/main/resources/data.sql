...
INSERT INTO product (condition, operating_principle,product_type, product_id, model, barrel_length, capacity, total_length, weight, color, params, brand_id, caliber_id, type_id, weapon_platform_id)
VALUES ('Новое','ПродольноСкользящийЗатвор','AMMO', 8,  '5.45 hp', null,  '17',     '1001',  'weight', 'Черный',    null,     2, 2,    6, null);;
INSERT INTO product (condition, operating_principle,product_type, product_id, model, barrel_length, capacity, total_length, weight, color, params, brand_id, caliber_id, type_id, weapon_platform_id)
VALUES ('Новое','ПродольноСкользящийЗатвор','AMMO', 9,  '5.45 hp', null,  '2',     '1200',  'weight', 'Черный',    null,     3, 3,    6, null);;
INSERT INTO product (condition, operating_principle,product_type, product_id, model, barrel_length, capacity, total_length, weight, color, params, brand_id, caliber_id, type_id, weapon_platform_id)
VALUES ('Новое','ПродольноСкользящийЗатвор','AMMO', 10, '5.45 hp', null,  '10',     '1040',  'weight', 'Черный',    null,     3, 4,    6, null);;
